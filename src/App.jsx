  ...
  const menu = [
...

    {
      ...
      items: [
...

        {
          name: "سجق مسوية",
          price: "450,000",
          desc: "ثوم - كبيس - بندورة مسوية",
        },

        {
          name: "لسانات",
          price: "450,000",
          desc: "خضار حارة - ثوم - كبيس - خس - ماشر",
        },
...

        {
          name: "زنجر موزاريلا",
          price: "450,000",
          desc: "صوص شدر - موزاريلا - ذرة - خس - جبنة موزاريلا",
        },
...

        {
          name: "ساندويش فروج",
          price: "450,000",
          desc: "ثوم - كبيس - بطاطا - بروستد فروج",
        },
...

        {
          name: "سودة",
          price: "450,000",
          desc: "ثوم - كبيس - بطاطا - بندورة مسوية - دبس رمان",
        },
...

        {
          name: "كريسبي سمك",
          price: "450,000",
          desc: "مايونيز - كبيس - ذرة - بالخردل",
        },

        {
          name: "بافلو تشكن",
          price: "450,000",
          desc: "صوص باربكيو - صوص شدر - خس - ذرة",
        },
...

        {
          name: "اسكالوب",
          price: "450,000",
          desc: "صوص كوكتيل - صوص شدر - سلطة - كبيس - بطاطا",
        },
...

    {
      ...
      items: [
        ...
        { name: "وجبة شاورما لحمه 2x", price: "600,000" },
...

    {
      ...
      items: [
        ...
        { name: "شقف وموزنه", price: "وسط: 350,000 | كبير: 450,000" },
        { name: "قشطة الملك", price: "وسط: 250,000 | كبير: 450,000" },
        { name: "ماندو وقشطة", price: "وسط: 250,000 | كبير: 450,000" },
        { name: "موز حليب وقشطة", price: "وسط: 200,000 | كبير: 300,000" },
